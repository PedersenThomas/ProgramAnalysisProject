...
public class TheLangLexer extends Lexer {
	...
	public final void mCOMMENT() throws RecognitionException {
		try {
			int _type = COMMENT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// .\\src\\thelang\\TheLang.g:158:9: ( '(*' ( options {greedy=false; } : . )* '*)' )
			// .\\src\\thelang\\TheLang.g:158:11: '(*' ( options {greedy=false; } : . )* '*)'
			{
			match("(*"); 

			// .\\src\\thelang\\TheLang.g:158:16: ( options {greedy=false; } : . )*
			loop1:
			while (true) {
				int alt1=2;
	...
	public final void mINTEGER() throws RecognitionException {
		try {
			int _type = INTEGER;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// .\\src\\thelang\\TheLang.g:161:9: ( ( '0' | '1' .. '9' ( '0' .. '9' )* ) )
			// .\\src\\thelang\\TheLang.g:161:11: ( '0' | '1' .. '9' ( '0' .. '9' )* )
			{
			// .\\src\\thelang\\TheLang.g:161:11: ( '0' | '1' .. '9' ( '0' .. '9' )* )
			int alt3=2;
			...
			switch (alt3) {
				case 1 :
					// .\\src\\thelang\\TheLang.g:161:12: '0'
					{
					match('0'); 
					}
					break;
				case 2 :
					// .\\src\\thelang\\TheLang.g:161:18: '1' .. '9' ( '0' .. '9' )*
					{
					matchRange('1','9'); 
					// .\\src\\thelang\\TheLang.g:161:27: ( '0' .. '9' )*
					loop2:
					while (true) {
						int alt2=2;
	...
	public final void mIDENTIFIER() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// .\\src\\thelang\\TheLang.g:163:12: ( LETTER ( LETTER | '0' .. '9' )* )
			// .\\src\\thelang\\TheLang.g:163:14: LETTER ( LETTER | '0' .. '9' )*
			{
			mLETTER(); 

			// .\\src\\thelang\\TheLang.g:163:21: ( LETTER | '0' .. '9' )*
			loop4:
			while (true) {
				int alt4=2;
	...
	public final void mLETTER() throws RecognitionException {
		try {
			// .\\src\\thelang\\TheLang.g:167:8: ( 'A' .. 'Z' | 'a' .. 'z' | '_' )
			// .\\src\\thelang\\TheLang.g:
			{
	...
	public final void mWS() throws RecognitionException {
		try {
			int _type = WS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// .\\src\\thelang\\TheLang.g:171:4: ( ( ' ' | '\\r' | '\\t' | '\\u000C' | '\\n' ) )
			// .\\src\\thelang\\TheLang.g:171:6: ( ' ' | '\\r' | '\\t' | '\\u000C' | '\\n' )
			{
