...
public class TheLangLexer extends Lexer {
    ...
    public final void mCOMMENT() throws RecognitionException {
        try {
            int _type = COMMENT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // .\\src\\thelang\\TheLang.g:133:9: ( '(*' ( options {greedy=false; } : . )* '*)' )
            // .\\src\\thelang\\TheLang.g:133:11: '(*' ( options {greedy=false; } : . )* '*)'
            {
            match("(*"); 



            // .\\src\\thelang\\TheLang.g:133:16: ( options {greedy=false; } : . )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mINTEGER() throws RecognitionException {
        try {
            int _type = INTEGER;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // .\\src\\thelang\\TheLang.g:136:9: ( ( '0' | '1' .. '9' ( '0' .. '9' )* ) )
            // .\\src\\thelang\\TheLang.g:136:11: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            {
            // .\\src\\thelang\\TheLang.g:136:11: ( '0' | '1' .. '9' ( '0' .. '9' )* )
            int alt3=2;
            ...
            switch (alt3) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // .\\src\\thelang\\TheLang.g:136:18: '1' .. '9' ( '0' .. '9' )*
                    {
                    matchRange('1','9'); 

                    // .\\src\\thelang\\TheLang.g:136:27: ( '0' .. '9' )*
                    loop2:
                    do {
                        int alt2=2;
    ...
    public final void mIDENTIFIER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // .\\src\\thelang\\TheLang.g:138:12: ( LETTER ( LETTER | '0' .. '9' )* )
            // .\\src\\thelang\\TheLang.g:138:14: LETTER ( LETTER | '0' .. '9' )*
            {
            mLETTER(); 


            // .\\src\\thelang\\TheLang.g:138:21: ( LETTER | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mLETTER() throws RecognitionException {
        try {
            // .\\src\\thelang\\TheLang.g:142:8: ( 'A' .. 'Z' | 'a' .. 'z' | '_' )
            // .\\src\\thelang\\TheLang.g:
            {
    ...
    public final void mWS() throws RecognitionException {
        try {
            int _type = WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // .\\src\\thelang\\TheLang.g:146:4: ( ( ' ' | '\\r' | '\\t' | '\\u000C' | '\\n' ) )
            // .\\src\\thelang\\TheLang.g:146:6: ( ' ' | '\\r' | '\\t' | '\\u000C' | '\\n' )
            {
